...
'Como eram chamados os pilotos suicidas da Segunda Guerra?','O que e gôndola?'],['O que e um oboe?\n','Que animal e usado no jogo de polo?','Em que ano ocorreu o incendio do edificio Joelma, na cidade de Sao Paulo?','Sobre qual cidade do Japao foi lançada a primeira bomba atomica?','O daltonico é deficiente em?','Qual e o dia da Padroeira do Brasil?','Qual e a capital do Estado de Mato Grosso do Sul?',
'Quantos são os continentes?','Por que nome são conhecidas as pessoas do Polo Artico?','Qual foi o ultimo imperador do Brasil?'], ['Quantos quilates tem o ouro puro?','Quem dirigiu o filme “Central do Brasil”?','Em qual pais está localizado o “Muro das lamentacoes”?','Qual desses paises nao fica na Asia?','Qual desses astros de filmes de acao e belga?','Onde foi conduzida a vitoria das forcas aliadas na Segunda Guerra Mundial?',
'Onde nasceu Van Gogh, o grande pintor impressionista?','O que significa literalmente Perestroika?','Qual desses quatro pesos e o mais leve?','Que conflito ideologico envolveu os EUA e a Uniao Sovietica?'],['Qual oceano tem o maior volume de agua?','Em que parte do nosso corpo está o umero?','Qual o nome verdadeiro do jogador de futebol conhecido com Zico?','O que significa deprecar?','Que cidade foi capital do Imperio Inca?','Com que outro nome e conhecido o Cabo Canaveral?',
...
var respCerta = [['b','b','b','d','d','c','c','b','b','b'],['a','c','c','b','d','b','d','a','c','c'],['d','c','b','d','b','b','a','a','b','d'],['c','b','b','a','c','b','b','a','c','d'],['b','d','b','c','d','b','a','c','a','a'],['b','c','c','c','c','a','c','c','d','a'],['b','d','c','b','c','d','c','c','a','a'],['c','b','d','d','c','a','d','a','b','a'],['c','d','d','d','d','b','d','c','b','a'],['b','a','a','d','d','c','a','c','c','b']];
var play = true;
var n = 0;
